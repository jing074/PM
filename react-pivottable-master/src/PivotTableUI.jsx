...
class PivotTableUI extends React.PureComponent {
  ...
  render() {
    let numValsAllowed =
     ...
     if(this.props.aggregators[this.props.aggregatorName]([])().isMultiVal)
     {
       incremental=true;
       numValsAllowed = this.props.vals.length +1;
     }
    ...
    const aggregatorCell = (
      <td className="pvtVals">
        <Dropdown
          ...
          setValue={value =>{ this.sendPropUpdate({aggregatorName: {$set: value},vals: {$set: []}});}}
        />
        <a
          role="button"
